...
const EditCourseOverlay = ({ course, onClose, onSave }) => {
  ...
  const handleSubmit = async () => {
    const { title, courseLink, instructor, price } = formData;

    if (!title || !courseLink || !instructor || !price) {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            {formData.courseCoverImg &&
              typeof formData.courseCoverImg !== "object" && (
                <img
                  src={formData.courseCoverImg}
                  alt="Cover Preview"
