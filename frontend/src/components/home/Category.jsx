...
export default function Category() {
  ...
  return (
    <div className="w-full mb-10 bg-gray-100">
      <Swiper
        modules={[Navigation]}
        navigation
        spaceBetween={20}
      ...
      >
        {category.map((cat, index) => (
          <SwiperSlide key={index}>
            <div className="flex cursor-pointer flex-col items-center justify-center my-10 bg-white rounded-lg shadow-md p-4 hover:bg-blue-100 transition duration-300">
