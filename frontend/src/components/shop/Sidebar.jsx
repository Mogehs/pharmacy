...
import { setCategory, setPriceRange } from "../features/shop/ShopSlice";
import { IoChevronBackSharp } from "react-icons/io5";
import { GrFormNext } from "react-icons/gr";

import { selectUniqueCategories } from "../features/shop/ShopSelector";
    ...
    <>
      ...
      <div
        className={`z-40 p-4 overflow-y-auto h-full w-80 fixed lg:static top-0 left-0 transform transition-transform duration-300 ease-in-out
          ...
          } lg:bg-transparent lg:shadow-none ml-[5px]`}
      >
        <div className="space-y-6 text-gray-500 ">
          <div className="border border-[#00B8A9] rounded  p-4 mt-28 lg:mt-0">
            <h2
              className="font-semibold text-2xl mb-3 border-b border-[#00B8A9] pb-2 text-[#00B8A9] "
          ...
          <div className="border border-[#00B8A9] rounded p-4">
            <h2
              className="font-semibold text-md mb-3 border-b border-dark-color pb-2 text-[#00B8A9] font-Fredoka text-2xl"
              style={{ fontFamily: "Fredoka, sans-serif" }}
            >
              Filter By Price
            </h2>
            ...
            <div className="flex justify-between text-sm mb-3">
              <span className="border border-[#00B8A9] px-2 py-1 rounded-md text-dark-color">
                $14.00
              </span>
              <span className="border border-[#00B8A9] px-2 py-1 rounded-md text-dark-color">
                ${price}.00
